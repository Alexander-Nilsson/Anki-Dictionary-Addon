...
class SettingsGui(QTabWidget):
    ...
    def initTooltips(self):
        ...
        self.openOnStart.setToolTip('Enable/Disable launching the Anki Dictionary on profile load.')
        linNote = ''
