...
class AddonState:
    ...
    def __init__(self) -> None:
        ...
        self.dictionary_instance: Any = None  # Will be properly typed when we fix the dictionary class
...
def initialize_addon() -> None:
    ...
    if hasattr(mw, '__dict__'):
        ...
        mw.__dict__['dictEditorLoadedAfterDictionary'] = state.editor_loaded_after_dictionary
        mw.__dict__['DictBulkMediaExportWasCancelled'] = state.bulk_media_export_cancelled
